...
public class OrgReportListResponseOrgReport {
   ...
   * @return OrgReportListResponseOrgReport
   **/
  public OrgReportListResponseOrgReport createdOn(OffsetDateTime createdOn) {
   ...
   * @return OrgReportListResponseOrgReport
   **/
  public OrgReportListResponseOrgReport customStartDate(OffsetDateTime customStartDate) {
   ...
   * @return OrgReportListResponseOrgReport
   **/
  public OrgReportListResponseOrgReport customEndDate(OffsetDateTime customEndDate) {
