...
public class RemoveUserProductsResponse {
   ...
   * @return RemoveUserProductsResponse
   **/
  public RemoveUserProductsResponse userProductResults(java.util.Map<String, String> userProductResults) {
   ...
   * @return RemoveUserProductsResponse
   **/
  public RemoveUserProductsResponse putUserProductResultsItem(String key, String userProductResultsItem) {
