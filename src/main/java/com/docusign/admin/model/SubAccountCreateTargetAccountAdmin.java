...
public class SubAccountCreateTargetAccountAdmin implements Serializable {
   ...
   * email.
   *
   * @return SubAccountCreateTargetAccountAdmin
   **/
  public SubAccountCreateTargetAccountAdmin email(String email) {
    this.email = email;
    return this;
  }
   ...
   * @return SubAccountCreateTargetAccountAdmin
   **/
  public SubAccountCreateTargetAccountAdmin firstName(String firstName) {
   ...
   * @return SubAccountCreateTargetAccountAdmin
   **/
  public SubAccountCreateTargetAccountAdmin lastName(String lastName) {
   ...
   * @return SubAccountCreateTargetAccountAdmin
   **/
  public SubAccountCreateTargetAccountAdmin locale(LocaleEnum locale) {
    this.locale = locale;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SubAccountCreateTargetAccountAdmin subAccountCreateTargetAccountAdmin = (SubAccountCreateTargetAccountAdmin) o;
    return Objects.equals(this.email, subAccountCreateTargetAccountAdmin.email) &&
        Objects.equals(this.firstName, subAccountCreateTargetAccountAdmin.firstName) &&
        Objects.equals(this.lastName, subAccountCreateTargetAccountAdmin.lastName) &&
        Objects.equals(this.locale, subAccountCreateTargetAccountAdmin.locale);
  }
