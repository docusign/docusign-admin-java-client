...
public class OrganizationAccountSettingsImportResponse {
   ...
   **/
  public OrganizationAccountSettingsImportResponse created(OffsetDateTime created) {
   ...
   * @return OrganizationAccountSettingsImportResponse
   **/
  public OrganizationAccountSettingsImportResponse lastModified(OffsetDateTime lastModified) {
   ...
   * @return OrganizationAccountSettingsImportResponse
   **/
  public OrganizationAccountSettingsImportResponse completed(OffsetDateTime completed) {
   ...
   * @return OrganizationAccountSettingsImportResponse
   **/
  public OrganizationAccountSettingsImportResponse expires(OffsetDateTime expires) {
