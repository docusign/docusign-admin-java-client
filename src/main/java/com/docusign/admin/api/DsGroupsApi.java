...
public class DsGroupsApi {
  ...
  **/
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DSGroupResponse > addDSGroupWithHttpInfo(java.util.UUID organizationId, java.util.UUID accountId, DSGroupAddRequest addRequest) throws ApiException {
    ...
    return new ApiResponse<DSGroupResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<AddDSGroupAndUsersResponse > addDSGroupUsersWithHttpInfo(java.util.UUID organizationId, java.util.UUID accountId, java.util.UUID dsGroupId, DSGroupUsersAddRequest dSGroupUsersAddRequest) throws ApiException {
    ...
    return new ApiResponse<AddDSGroupAndUsersResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Object> deleteDSGroupWithHttpInfo(java.util.UUID organizationId, java.util.UUID accountId, java.util.UUID dsGroupId) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DSGroupResponse > getDSGroupWithHttpInfo(java.util.UUID organizationId, java.util.UUID accountId, java.util.UUID dsGroupId) throws ApiException {
    Object localVarPostBody = "{}";
  ...
  */
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DSGroupAndUsersResponse > getDSGroupUsersWithHttpInfo(java.util.UUID organizationId, java.util.UUID accountId, java.util.UUID dsGroupId, DsGroupsApi.GetDSGroupUsersOptions options) throws ApiException {
    Object localVarPostBody = "{}";
    ...
    return new ApiResponse<DSGroupAndUsersResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  /// <summary>
  ...
  */
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DSGroupListResponse > getDSGroupsWithHttpInfo(java.util.UUID organizationId, java.util.UUID accountId, DsGroupsApi.GetDSGroupsOptions options) throws ApiException {
    Object localVarPostBody = "{}";
    ...
    return new ApiResponse<DSGroupListResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RemoveDSGroupUsersResponse > removeDSGroupUsersWithHttpInfo(java.util.UUID organizationId, java.util.UUID accountId, java.util.UUID dsGroupId, DSGroupUsersRemoveRequest dSGroupUsersRemoveRequest) throws ApiException {
    ...
    return new ApiResponse<RemoveDSGroupUsersResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
}
