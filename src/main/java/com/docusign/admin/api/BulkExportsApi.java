...
public class BulkExportsApi {
  ...
  public OrganizationExportResponse createAccountSettingsExport(java.util.UUID organizationId,
    ...
    ApiResponse<OrganizationExportResponse> localVarResponse = createAccountSettingsExportWithHttpInfo(organizationId,
        request);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<OrganizationExportResponse> createAccountSettingsExportWithHttpInfo(java.util.UUID organizationId,
      OrganizationAccountsRequest request) throws ApiException {
    ...
    return new ApiResponse<OrganizationExportResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(),
        localVarResponse);
  }
  ...
  public OrganizationExportResponse createUserListExport(java.util.UUID organizationId,
    ...
    ApiResponse<OrganizationExportResponse> localVarResponse = createUserListExportWithHttpInfo(organizationId,
        request);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<OrganizationExportResponse> createUserListExportWithHttpInfo(java.util.UUID organizationId,
      OrganizationExportRequest request) throws ApiException {
    Object localVarPostBody = request;
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Object> deleteAccountSettingsExportWithHttpInfo(java.util.UUID organizationId,
      java.util.UUID exportId) throws ApiException {
    Object localVarPostBody = "{}";

    // verify the required parameter 'organizationId' is set
    if (organizationId == null) {
      throw new ApiException(400,
          "Missing the required parameter 'organizationId' when calling deleteAccountSettingsExport");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Object> deleteUserListExportWithHttpInfo(java.util.UUID organizationId, java.util.UUID exportId)
      throws ApiException {
    Object localVarPostBody = "{}";
   ...
   * @throws ApiException if fails to make API call
   */
  public OrganizationExportResponse getAccountSettingsExport(java.util.UUID organizationId, java.util.UUID exportId)
      throws ApiException {
    ApiResponse<OrganizationExportResponse> localVarResponse = getAccountSettingsExportWithHttpInfo(organizationId,
        exportId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<OrganizationExportResponse> getAccountSettingsExportWithHttpInfo(java.util.UUID organizationId,
      java.util.UUID exportId) throws ApiException {
    Object localVarPostBody = "{}";
    ...
    if (organizationId == null) {
      throw new ApiException(400,
          "Missing the required parameter 'organizationId' when calling getAccountSettingsExport");
    }
    ...
    OrganizationExportResponse localVarResponse = apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams,
        localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept,
        localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<OrganizationExportResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(),
        localVarResponse);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<OrganizationExportsResponse> getAccountSettingsExportsWithHttpInfo(java.util.UUID organizationId)
      throws ApiException {
    Object localVarPostBody = "{}";
    ...
    if (organizationId == null) {
      throw new ApiException(400,
          "Missing the required parameter 'organizationId' when calling getAccountSettingsExports");
    }
    ...
    OrganizationExportsResponse localVarResponse = apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams,
        localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept,
        localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<OrganizationExportsResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(),
        localVarResponse);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public OrganizationExportResponse getUserListExport(java.util.UUID organizationId, java.util.UUID exportId)
      throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<OrganizationExportResponse> getUserListExportWithHttpInfo(java.util.UUID organizationId,
      java.util.UUID exportId) throws ApiException {
    Object localVarPostBody = "{}";
  ...
  /**
   * Returns a list of existing User List Exports (requests and completed exports)
   * and their details/metadata.
   * Required scopes: user_read
   * 
   * @param organizationId The organization ID Guid (required)
   * @return OrganizationExportsResponse
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<OrganizationExportsResponse> getUserListExportsWithHttpInfo(java.util.UUID organizationId)
      throws ApiException {
    Object localVarPostBody = "{}";
