...
public class ReservedDomainsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DomainsResponse> getReservedDomainsWithHttpInfo(java.util.UUID organizationId)
      throws ApiException {
    ...
    DomainsResponse localVarResponse = apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams,
    ...
    return new ApiResponse<DomainsResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(),
        localVarResponse);
  }
}
