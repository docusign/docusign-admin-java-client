...
public class ReservedDomainsApi {
  ...
  **/
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DomainsResponse > getReservedDomainsWithHttpInfo(java.util.UUID organizationId) throws ApiException {
    ...
    String localVarPath = "/v2/organizations/{organizationId}/reserved_domains"
    ...
    DomainsResponse localVarResponse = apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<DomainsResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
}
