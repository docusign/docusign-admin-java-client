...
public class IdentityProvidersApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<IdentityProvidersResponse> getIdentityProvidersWithHttpInfo(java.util.UUID organizationId)
      throws ApiException {
    ...
    IdentityProvidersResponse localVarResponse = apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams,
    ...
    return new ApiResponse<IdentityProvidersResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(),
        localVarResponse);
  }
}
